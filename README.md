...
To have the URL in the browser display the primary domain even when coming from a secondary domain, redirect domain aliases to the primary domain using the [netlify.toml](./netlify.toml) configuration file.
